...
class Realtime_Pipeline:
    ...
    def voice_conversion(
        ...
        with torch.no_grad():
            ...
            if profiler:
                profiler.mark("pitch_extraction")
