...
cd /home/tester
find . -xdev \( -path ./RVC-Voice-Changer -o -path ./.cache \) -prune -o -type f -print0 | xargs -0 sha256sum | sort -k2 >"$out/home-files"
find . -xdev \( -path ./RVC-Voice-Changer -o -path ./.cache \) -prune -o -type d -print | sort >"$out/home-folders"
